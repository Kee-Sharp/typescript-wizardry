...
type NumRowsWithCell<Maze extends AnyMaze, Cell extends MazeCell> = Length<Filter<Maze, Exclude<MazeCell, Cell>[]>>;

type IsValidMaze<Maze extends AnyMaze> =
  NumRowsWithCell<Maze, Start> extends 1
...
type AddWithNegative<N extends number, M extends number> = M extends -1 ? Sub<N, 1> : Add<N, M>;
...
> = 
  OpenList extends [infer CurrentState extends State, ...infer OtherOpenStates extends State[]]
    ...
    : 'no possible path';
export type MazeSolver<Maze extends AnyMaze> = IsValidMaze<Maze> extends true ? MazeHelper<Maze, [[StartPos<Maze>, []]]> : 'invalid maze';
